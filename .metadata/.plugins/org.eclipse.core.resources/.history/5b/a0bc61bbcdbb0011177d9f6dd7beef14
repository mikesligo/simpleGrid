...
public interface House extends EObject {
	...
	/**
	 * Sets the value of the '{@link simpleGrid.House#getParent <em>Parent</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setAir_temperature(double value);
	 ...
	 * @generated
	 */
	void setFloor_area(double value);
	 ...
	 * @generated
	 */
	void setCooling_setpoint(double value);
	 ...
	 * @generated
	 */
	void setHeating_setpoint(double value);
	 ...
	 * @see #setThermal_integrity_level(double)
	 * @see simpleGrid.SimpleGridPackage#getHouse_Thermal_integrity_level()
	 * @model
	 * @generated
	 */
	double getThermal_integrity_level();
	 ...
	 * @generated
	 */
	void setThermal_integrity_level(double value);
	 ...
	 * @generated
	 */
	void setMass_temperature(double value);
	 ...
	 * @generated
	 */
	void setHeating_COP(double value);
	...
	/**
	 * Returns the value of the '<em><b>Aux heat temperature lockout</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Aux heat temperature lockout</em>' containment reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Aux heat temperature lockout</em>' containment reference.
	 * @see #setAux_heat_temperature_lockout(EObject)
	 * @see simpleGrid.SimpleGridPackage#getHouse_Aux_heat_temperature_lockout()
	 * @model containment="true"
	 * @generated
	 */
	EObject getAux_heat_temperature_lockout();

	/**
	 * Sets the value of the '{@link simpleGrid.House#getAux_heat_temperature_lockout <em>Aux heat temperature lockout</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Aux heat temperature lockout</em>' containment reference.
	 * @see #getAux_heat_temperature_lockout()
	 * @generated
	 */
	void setAux_heat_temperature_lockout(EObject value);
	 ...
	 * @generated
	 */
	void setCooling_COP(double value);
