...
/**
 * This is the item provider adapter for a {@link simpleGrid.Triplex_node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Triplex_node_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Triplex_node_length_feature", "_UI_Triplex_node_type"),
				 SimpleGridPackage.Literals.TRIPLEX_NODE__LENGTH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimpleGridPackage.Literals.TRIPLEX_NODE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimpleGridPackage.Literals.TRIPLEX_NODE__PHASES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFromPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Triplex_node_from_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Triplex_node_from_feature", "_UI_Triplex_node_type"),
				 SimpleGridPackage.Literals.TRIPLEX_NODE__FROM,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Triplex_node_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Triplex_node_to_feature", "_UI_Triplex_node_type"),
				 SimpleGridPackage.Literals.TRIPLEX_NODE__TO,
				 true,
				 false,
				 true,
				 null,
