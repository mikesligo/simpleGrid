...
public class SimpleGridPackageImpl extends EPackageImpl implements SimpleGridPackage {
	 ...
	 * @generated
	 */
	public EReference getClimate_Object() {
		return (EReference)climateEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getTransformer_configuration_Primary_voltage() {
		return (EReference)transformer_configurationEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EReference getTransformer_configuration_Secondary_voltage() {
		return (EReference)transformer_configurationEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EReference getTransformer_configuration_Object() {
		return (EReference)transformer_configurationEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 * @generated
	 */
	public EReference getNode_Voltage_A() {
	 ...
	 * @generated
	 */
	public EReference getNode_Voltage_B() {
	 ...
	 * @generated
	 */
	public EReference getNode_Voltage_C() {
	 ...
	 * @generated
	 */
	public EReference getTransformer_From() {
	 ...
	 * @generated
	 */
	public EReference getTransformer_To() {
	 ...
	 * @generated
	 */
	public EReference getTriplex_node_From() {
	 ...
	 * @generated
	 */
	public EReference getTriplex_node_To() {
		return (EReference)triplex_nodeEClass.getEStructuralFeatures().get(4);
	}
	...
	public EReference getTriplex_node_Triplex_line() {
		return (EReference)triplex_nodeEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getHouse_Parent() {
	 ...
	 * @generated
	 */
	public EReference getHouse_Aux_heat_temperature_lockout() {
	...
	public EReference getHouse_Waterheater() {
		return (EReference)houseEClass.getEStructuralFeatures().get(17);
	}
	 ...
	 * @generated
	 */
	public EReference getWaterheater_Heating_element_capacity() {
		return (EReference)waterheaterEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getTriplex_line_From() {
	 ...
	 * @generated
	 */
	public EReference getTriplex_line_To() {
	...
	public EReference getTriplex_line_Triplex_line_configuration() {
		return (EReference)triplex_lineEClass.getEStructuralFeatures().get(5);
	}
	...
	public EReference getTriplex_line_Triplex_meter() {
		return (EReference)triplex_lineEClass.getEStructuralFeatures().get(6);
	}
	...
	public void createPackageContents() {
		...
		createEReference(climateEClass, CLIMATE__OBJECT);
		...
		createEReference(transformer_configurationEClass, TRANSFORMER_CONFIGURATION__PRIMARY_VOLTAGE);
		createEReference(transformer_configurationEClass, TRANSFORMER_CONFIGURATION__SECONDARY_VOLTAGE);
		createEReference(transformer_configurationEClass, TRANSFORMER_CONFIGURATION__OBJECT);

		nodeEClass = createEClass(NODE);
		createEAttribute(nodeEClass, NODE__NAME);
		createEAttribute(nodeEClass, NODE__PHASES);
		createEAttribute(nodeEClass, NODE__BUSTYPE);
		createEReference(nodeEClass, NODE__VOLTAGE_A);
		createEReference(nodeEClass, NODE__VOLTAGE_B);
		createEReference(nodeEClass, NODE__VOLTAGE_C);
		...
		createEReference(transformerEClass, TRANSFORMER__FROM);
		createEReference(transformerEClass, TRANSFORMER__TO);
		...
		createEReference(triplex_nodeEClass, TRIPLEX_NODE__FROM);
		createEReference(triplex_nodeEClass, TRIPLEX_NODE__TO);
		...
		createEReference(houseEClass, HOUSE__PARENT);
		...
		createEReference(houseEClass, HOUSE__AUX_HEAT_TEMPERATURE_LOCKOUT);
		...
		createEReference(waterheaterEClass, WATERHEATER__HEATING_ELEMENT_CAPACITY);
		...
		createEReference(triplex_lineEClass, TRIPLEX_LINE__FROM);
		createEReference(triplex_lineEClass, TRIPLEX_LINE__TO);
	...
	public void initializePackageContents() {
		...
		initEReference(getClimate_Object(), ecorePackage.getEObject(), null, "object", null, 0, -1, Climate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTriplex_Line_configuration_Insulation_thickness(), ecorePackage.getEDouble(), "insulation_thickness", null, 0, 1, Triplex_Line_configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTriplex_Line_configuration_Diameter(), ecorePackage.getEDouble(), "diameter", null, 0, 1, Triplex_Line_configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTransformer_configuration_Power_rating(), ecorePackage.getEDouble(), "power_rating", null, 0, 1, Transformer_configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransformer_configuration_Primary_voltage(), ecorePackage.getEObject(), null, "primary_voltage", null, 0, 1, Transformer_configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransformer_configuration_Secondary_voltage(), ecorePackage.getEObject(), null, "secondary_voltage", null, 0, 1, Transformer_configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransformer_configuration_Object(), ecorePackage.getEObject(), null, "object", null, 0, -1, Transformer_configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNode_Voltage_A(), ecorePackage.getEObject(), null, "voltage_A", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNode_Voltage_B(), ecorePackage.getEObject(), null, "voltage_B", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNode_Voltage_C(), ecorePackage.getEObject(), null, "voltage_C", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransformer_From(), ecorePackage.getEObject(), null, "from", null, 0, 1, Transformer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransformer_To(), ecorePackage.getEObject(), null, "to", null, 0, 1, Transformer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTriplex_node_Length(), ecorePackage.getEDouble(), "length", null, 0, 1, Triplex_node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTriplex_node_From(), ecorePackage.getEObject(), null, "from", null, 0, 1, Triplex_node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTriplex_node_To(), ecorePackage.getEObject(), null, "to", null, 0, 1, Triplex_node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTriplex_meter_Normal_voltages(), ecorePackage.getEDouble(), "normal_voltages", null, 0, 1, Triplex_meter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getHouse_Parent(), ecorePackage.getEObject(), null, "parent", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Schedule_skew(), ecorePackage.getEDouble(), "schedule_skew", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Air_temperature(), ecorePackage.getEDouble(), "air_temperature", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Floor_area(), ecorePackage.getEDouble(), "floor_area", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Cooling_setpoint(), ecorePackage.getEDouble(), "cooling_setpoint", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Heating_setpoint(), ecorePackage.getEDouble(), "heating_setpoint", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Thermal_integrity_level(), ecorePackage.getEDouble(), "thermal_integrity_level", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getHouse_Mass_temperature(), ecorePackage.getEDouble(), "mass_temperature", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getHouse_Heating_COP(), ecorePackage.getEDouble(), "heating_COP", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getHouse_Aux_heat_temperature_lockout(), ecorePackage.getEObject(), null, "aux_heat_temperature_lockout", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Cooling_COP(), ecorePackage.getEDouble(), "cooling_COP", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getWaterheater_Tank_volume(), ecorePackage.getEDouble(), "tank_volume", null, 0, 1, Waterheater.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getWaterheater_Heating_element_capacity(), ecorePackage.getEObject(), null, "heating_element_capacity", null, 0, 1, Waterheater.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWaterheater_Tank_setpoint(), ecorePackage.getEDouble(), "tank_setpoint", null, 0, 1, Waterheater.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWaterheater_Temperature(), ecorePackage.getEDouble(), "temperature", null, 0, 1, Waterheater.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWaterheater_Thermostat_deadband(), ecorePackage.getEDouble(), "thermostat_deadband", null, 0, 1, Waterheater.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getWaterheater_Tank_UA(), ecorePackage.getEDouble(), "tank_UA", null, 0, 1, Waterheater.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWaterheater_Schedule_skew(), ecorePackage.getEDouble(), "schedule_skew", null, 0, 1, Waterheater.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWaterheater_Demand_skew(), ecorePackage.getEDouble(), "demand_skew", null, 0, 1, Waterheater.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTriplex_line_Length(), ecorePackage.getEDouble(), "length", null, 0, 1, Triplex_line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTriplex_line_From(), ecorePackage.getEObject(), null, "from", null, 0, 1, Triplex_line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTriplex_line_To(), ecorePackage.getEObject(), null, "to", null, 0, 1, Triplex_line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTriplex_line_conductor_Resistance(), ecorePackage.getEDouble(), "resistance", null, 0, 1, Triplex_line_conductor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTriplex_line_conductor_Geometric_mean_radius(), ecorePackage.getEDouble(), "geometric_mean_radius", null, 0, 1, Triplex_line_conductor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
