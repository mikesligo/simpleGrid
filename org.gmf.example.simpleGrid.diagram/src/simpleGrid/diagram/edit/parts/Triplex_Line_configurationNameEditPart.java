 ...
 * @generated
 */
public class Triplex_Line_configurationNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Triplex_Line_configurationNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new simpleGrid.diagram.edit.policies.SimpleGridTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new simpleGrid.diagram.edit.parts.GridEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return simpleGrid.diagram.providers.SimpleGridElementTypes
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof simpleGrid.diagram.edit.policies.SimpleGridTextSelectionEditPolicy) {
			((simpleGrid.diagram.edit.policies.SimpleGridTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof simpleGrid.diagram.edit.policies.SimpleGridTextSelectionEditPolicy) {
			((simpleGrid.diagram.edit.policies.SimpleGridTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = simpleGrid.diagram.providers.SimpleGridParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this,
					...
					simpleGrid.diagram.edit.parts.SimpleGridEditPartFactory
