 ...
 * @generated
 */
public class Triplex_Line_configurationItemSemanticEditPolicy extends
		simpleGrid.diagram.edit.policies.SimpleGridBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Triplex_Line_configurationItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(incomingLink) == simpleGrid.diagram.edit.parts.Triplex_lineTriplex_line_configurationEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(outgoingLink) == simpleGrid.diagram.edit.parts.Triplex_Line_configurationTriplex_line_conductorEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_Line_configurationTriplex_line_conductor_4008 == req
				.getElementType()) {
			return getGEFWrapper(new simpleGrid.diagram.edit.commands.Triplex_Line_configurationTriplex_line_conductorCreateCommand(
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case simpleGrid.diagram.edit.parts.Triplex_Line_configurationTriplex_line_conductorEditPart.VISUAL_ID:
			return getGEFWrapper(new simpleGrid.diagram.edit.commands.Triplex_Line_configurationTriplex_line_conductorReorientCommand(
					req));
