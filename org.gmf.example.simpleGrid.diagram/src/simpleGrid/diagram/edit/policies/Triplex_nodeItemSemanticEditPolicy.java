 ...
 * @generated
 */
public class Triplex_nodeItemSemanticEditPolicy extends
		simpleGrid.diagram.edit.policies.SimpleGridBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Triplex_nodeItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(incomingLink) == simpleGrid.diagram.edit.parts.TransformerTriplex_nodeEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(outgoingLink) == simpleGrid.diagram.edit.parts.Triplex_nodeFromEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(outgoingLink) == simpleGrid.diagram.edit.parts.Triplex_nodeTriplex_lineEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(outgoingLink) == simpleGrid.diagram.edit.parts.Triplex_nodeToEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
