 ...
 * @generated
 */
public class Triplex_lineItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(incomingLink) == simpleGrid.diagram.edit.parts.Triplex_nodeTriplex_lineEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(outgoingLink) == simpleGrid.diagram.edit.parts.Triplex_lineToEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(outgoingLink) == simpleGrid.diagram.edit.parts.Triplex_lineFromEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(outgoingLink) == simpleGrid.diagram.edit.parts.Triplex_lineTriplex_meterEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(outgoingLink) == simpleGrid.diagram.edit.parts.Triplex_lineTriplex_line_configurationEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_nodeTriplex_line_4005 == req
				.getElementType()) {
			return null;
		}
		if (simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_lineTriplex_meter_4007 == req
				.getElementType()) {
			return getGEFWrapper(new simpleGrid.diagram.edit.commands.Triplex_lineTriplex_meterCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_lineTriplex_line_configuration_4011 == req
				.getElementType()) {
			return getGEFWrapper(new simpleGrid.diagram.edit.commands.Triplex_lineTriplex_line_configurationCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_nodeTriplex_line_4005 == req
				.getElementType()) {
			return getGEFWrapper(new simpleGrid.diagram.edit.commands.Triplex_nodeTriplex_lineCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_lineTriplex_meter_4007 == req
				.getElementType()) {
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case simpleGrid.diagram.edit.parts.Triplex_nodeTriplex_lineEditPart.VISUAL_ID:
			return getGEFWrapper(new simpleGrid.diagram.edit.commands.Triplex_nodeTriplex_lineReorientCommand(
					req));
		case simpleGrid.diagram.edit.parts.Triplex_lineTriplex_meterEditPart.VISUAL_ID:
			return getGEFWrapper(new simpleGrid.diagram.edit.commands.Triplex_lineTriplex_meterReorientCommand(
					req));
		case simpleGrid.diagram.edit.parts.Triplex_lineTriplex_line_configurationEditPart.VISUAL_ID:
			return getGEFWrapper(new simpleGrid.diagram.edit.commands.Triplex_lineTriplex_line_configurationReorientCommand(
					req));
