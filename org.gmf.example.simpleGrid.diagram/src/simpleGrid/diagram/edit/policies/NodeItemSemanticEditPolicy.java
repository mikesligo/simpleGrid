...
public class NodeItemSemanticEditPolicy extends
	...
	public NodeItemSemanticEditPolicy() {
		super(simpleGrid.diagram.providers.SimpleGridElementTypes.Node_2007);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (simpleGrid.diagram.part.SimpleGridVisualIDRegistry
					.getVisualID(outgoingLink) == simpleGrid.diagram.edit.parts.NodeTransformerEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
