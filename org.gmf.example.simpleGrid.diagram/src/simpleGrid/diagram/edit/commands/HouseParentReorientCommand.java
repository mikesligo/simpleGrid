 ...
 * @generated
 */
public class HouseParentReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HouseParentReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof EObject && newEnd instanceof simpleGrid.House)) {
			return false;
		}
		return simpleGrid.diagram.edit.policies.SimpleGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistHouseParent_4002(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return simpleGrid.diagram.edit.policies.SimpleGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistHouseParent_4002(getOldSource(),
						getNewTarget());
	}
