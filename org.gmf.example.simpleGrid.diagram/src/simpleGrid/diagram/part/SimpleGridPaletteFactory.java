...
public class SimpleGridPaletteFactory {
	...
	private ToolEntry createHouse13CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(simpleGrid.diagram.providers.SimpleGridElementTypes.WaterheaterHeating_element_capacity_4010));
		entry.setId("createHouse13CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(simpleGrid.diagram.providers.SimpleGridElementTypes
				.getImageDescriptor(simpleGrid.diagram.providers.SimpleGridElementTypes.WaterheaterHeating_element_capacity_4010));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createWaterheater15CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(simpleGrid.diagram.providers.SimpleGridElementTypes.TransformerFrom_4016));
		entry.setId("createWaterheater15CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(simpleGrid.diagram.providers.SimpleGridElementTypes
				.getImageDescriptor(simpleGrid.diagram.providers.SimpleGridElementTypes.TransformerFrom_4016));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
