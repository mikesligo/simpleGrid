...
public class SimpleGridPaletteFactory {
	...
	private ToolEntry createTriplex_meterHouse12CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_meterHouse_4001));
		entry.setId("createTriplex_meterHouse12CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(simpleGrid.diagram.providers.SimpleGridElementTypes
				.getImageDescriptor(simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_meterHouse_4001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createHouse13CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(simpleGrid.diagram.providers.SimpleGridElementTypes.HouseParent_4002));
		entry.setId("createHouse13CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(simpleGrid.diagram.providers.SimpleGridElementTypes
				.getImageDescriptor(simpleGrid.diagram.providers.SimpleGridElementTypes.HouseParent_4002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createHouseWaterheater14CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_lineFrom_4003));
		entry.setId("createHouseWaterheater14CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(simpleGrid.diagram.providers.SimpleGridElementTypes
				.getImageDescriptor(simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_lineFrom_4003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createTriplex_lineTriplex_line_configuration17CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(simpleGrid.diagram.providers.SimpleGridElementTypes.TransformerTransformer_configuration_4006));
		entry.setId("createTriplex_lineTriplex_line_configuration17CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(simpleGrid.diagram.providers.SimpleGridElementTypes
				.getImageDescriptor(simpleGrid.diagram.providers.SimpleGridElementTypes.TransformerTransformer_configuration_4006));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
