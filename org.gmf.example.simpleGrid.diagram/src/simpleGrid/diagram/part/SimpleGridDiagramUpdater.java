...
public class SimpleGridDiagramUpdater {
	...
	public static List<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getTriplex_node_2002ContainedLinks(
		...
		simpleGrid.Triplex_node modelElement = (simpleGrid.Triplex_node) view
				.getElement();
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_Triplex_node_From_4004(modelElement));
		result.addAll(getOutgoingFeatureModelFacetLinks_Triplex_node_Triplex_line_4005(modelElement));
		result.addAll(getOutgoingFeatureModelFacetLinks_Triplex_node_To_4009(modelElement));
		return result;
	}
	...
	public static List<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getWaterheater_2003ContainedLinks(
		...
		simpleGrid.Waterheater modelElement = (simpleGrid.Waterheater) view
				.getElement();
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_Waterheater_Heating_element_capacity_4010(modelElement));
		return result;
	}
	...
	public static List<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getTriplex_line_2006ContainedLinks(
		...
		simpleGrid.Triplex_line modelElement = (simpleGrid.Triplex_line) view
				.getElement();
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_Triplex_line_From_4003(modelElement));
		...
		result.addAll(getOutgoingFeatureModelFacetLinks_Triplex_line_To_4015(modelElement));
		return result;
	}
	...
	public static List<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getTransformer_2010ContainedLinks(
		...
		result.addAll(getOutgoingFeatureModelFacetLinks_Transformer_To_4012(modelElement));
		result.addAll(getOutgoingFeatureModelFacetLinks_Transformer_Triplex_node_4013(modelElement));
		result.addAll(getOutgoingFeatureModelFacetLinks_Transformer_From_4016(modelElement));
		return result;
	}
	...
	public static List<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getHouse_2011ContainedLinks(
		...
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_House_Parent_4002(modelElement));
	...
	public static List<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getTriplex_Line_configuration_2001IncomingLinks(
		...
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		result.addAll(getIncomingFeatureModelFacetLinks_House_Parent_4002(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Triplex_line_From_4003(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Triplex_node_From_4004(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Triplex_node_To_4009(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Waterheater_Heating_element_capacity_4010(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Triplex_line_Triplex_line_configuration_4011(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Transformer_To_4012(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Triplex_line_To_4015(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Transformer_From_4016(
				modelElement, crossReferences));
		return result;
	}
	...
	public static List<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getClimate_2009IncomingLinks(
			View view) {
		simpleGrid.Climate modelElement = (simpleGrid.Climate) view
				.getElement();
		Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
				.find(view.eResource().getResourceSet().getResources());
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getIncomingFeatureModelFacetLinks_House_Parent_4002(
			EObject target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == simpleGrid.SimpleGridPackage.eINSTANCE
				...
				result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
						...
						simpleGrid.diagram.edit.parts.HouseParentEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getIncomingFeatureModelFacetLinks_Triplex_line_From_4003(
			EObject target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == simpleGrid.SimpleGridPackage.eINSTANCE
				...
				result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
						...
						simpleGrid.diagram.edit.parts.Triplex_lineFromEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getIncomingFeatureModelFacetLinks_Triplex_node_From_4004(
			EObject target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == simpleGrid.SimpleGridPackage.eINSTANCE
				...
				result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
						setting.getEObject(),
						(EObject) target,
						simpleGrid.diagram.providers.SimpleGridElementTypes.Triplex_nodeFrom_4004,
						simpleGrid.diagram.edit.parts.Triplex_nodeFromEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getIncomingFeatureModelFacetLinks_Triplex_node_To_4009(
			EObject target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == simpleGrid.SimpleGridPackage.eINSTANCE
				...
				result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
						...
						simpleGrid.diagram.edit.parts.Triplex_nodeToEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getIncomingFeatureModelFacetLinks_Waterheater_Heating_element_capacity_4010(
			EObject target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == simpleGrid.SimpleGridPackage.eINSTANCE
				...
				result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
						...
						simpleGrid.diagram.edit.parts.WaterheaterHeating_element_capacityEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getIncomingFeatureModelFacetLinks_Transformer_To_4012(
			EObject target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == simpleGrid.SimpleGridPackage.eINSTANCE
				...
				result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
						setting.getEObject(),
						(EObject) target,
						simpleGrid.diagram.providers.SimpleGridElementTypes.TransformerTo_4012,
						simpleGrid.diagram.edit.parts.TransformerToEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getIncomingFeatureModelFacetLinks_Triplex_line_To_4015(
			EObject target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == simpleGrid.SimpleGridPackage.eINSTANCE
				...
				result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
						...
						simpleGrid.diagram.edit.parts.Triplex_lineToEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getIncomingFeatureModelFacetLinks_Transformer_From_4016(
			EObject target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == simpleGrid.SimpleGridPackage.eINSTANCE
				...
				result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
						setting.getEObject(),
						(EObject) target,
						simpleGrid.diagram.providers.SimpleGridElementTypes.TransformerFrom_4016,
						simpleGrid.diagram.edit.parts.TransformerFromEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getOutgoingFeatureModelFacetLinks_House_Parent_4002(
			simpleGrid.House source) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		EObject destination = source.getParent();
		if (destination == null) {
			return result;
		}
		result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getOutgoingFeatureModelFacetLinks_Triplex_line_From_4003(
			simpleGrid.Triplex_line source) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		EObject destination = source.getFrom();
		if (destination == null) {
			return result;
		}
		result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getOutgoingFeatureModelFacetLinks_Triplex_node_From_4004(
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getOutgoingFeatureModelFacetLinks_Triplex_node_To_4009(
			simpleGrid.Triplex_node source) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		EObject destination = source.getTo();
		if (destination == null) {
			return result;
		}
		result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getOutgoingFeatureModelFacetLinks_Waterheater_Heating_element_capacity_4010(
			simpleGrid.Waterheater source) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		EObject destination = source.getHeating_element_capacity();
		if (destination == null) {
			return result;
		}
		result.add(new simpleGrid.diagram.part.SimpleGridLinkDescriptor(
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getOutgoingFeatureModelFacetLinks_Transformer_To_4012(
			simpleGrid.Transformer source) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		EObject destination = source.getTo();
		if (destination == null) {
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getOutgoingFeatureModelFacetLinks_Triplex_line_To_4015(
			simpleGrid.Triplex_line source) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		EObject destination = source.getTo();
		if (destination == null) {
	 ...
	 * @generated
	 */
	private static Collection<simpleGrid.diagram.part.SimpleGridLinkDescriptor> getOutgoingFeatureModelFacetLinks_Transformer_From_4016(
			simpleGrid.Transformer source) {
		LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor> result = new LinkedList<simpleGrid.diagram.part.SimpleGridLinkDescriptor>();
		EObject destination = source.getFrom();
		if (destination == null) {
