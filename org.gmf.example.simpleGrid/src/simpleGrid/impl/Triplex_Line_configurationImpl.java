...
public class Triplex_Line_configurationImpl extends EObjectImpl implements Triplex_Line_configuration {
	 ...
	 * @ordered
	 */
	protected static final double INSULATION_THICKNESS_EDEFAULT = 0.0;
	 ...
	 * @ordered
	 */
	protected double insulation_thickness = INSULATION_THICKNESS_EDEFAULT;
	 ...
	 * @generated
	 */
	public double getInsulation_thickness() {
	 ...
	 * @generated
	 */
	public void setInsulation_thickness(double newInsulation_thickness) {
		double oldInsulation_thickness = insulation_thickness;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SimpleGridPackage.TRIPLEX_LINE_CONFIGURATION__NAME:
				...
				return;
			case SimpleGridPackage.TRIPLEX_LINE_CONFIGURATION__INSULATION_THICKNESS:
				setInsulation_thickness((Double)newValue);
				return;
			case SimpleGridPackage.TRIPLEX_LINE_CONFIGURATION__DIAMETER:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimpleGridPackage.TRIPLEX_LINE_CONFIGURATION__INSULATION_THICKNESS:
				return insulation_thickness != INSULATION_THICKNESS_EDEFAULT;
			case SimpleGridPackage.TRIPLEX_LINE_CONFIGURATION__DIAMETER:
