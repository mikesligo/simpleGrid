...
public class TransformerImpl extends EObjectImpl implements Transformer {
	...
	public EObject getFrom() {
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleGridPackage.TRANSFORMER__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public EObject getTo() {
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleGridPackage.TRANSFORMER__TO, oldTo, to));
			}
		}
		return to;
	}
