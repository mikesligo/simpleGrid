...
public class Triplex_meterImpl extends EObjectImpl implements Triplex_meter {
	 ...
	 * @ordered
	 */
	protected static final double NORMAL_VOLTAGES_EDEFAULT = 0.0;
	 ...
	 * @ordered
	 */
	protected double normal_voltages = NORMAL_VOLTAGES_EDEFAULT;
	 ...
	 * @generated
	 */
	public double getNormal_voltages() {
	 ...
	 * @generated
	 */
	public void setNormal_voltages(double newNormal_voltages) {
		double oldNormal_voltages = normal_voltages;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimpleGridPackage.TRIPLEX_METER__PHASES:
				...
				return;
			case SimpleGridPackage.TRIPLEX_METER__NORMAL_VOLTAGES:
				setNormal_voltages((Double)newValue);
				return;
			case SimpleGridPackage.TRIPLEX_METER__HOUSE:
				getHouse().clear();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimpleGridPackage.TRIPLEX_METER__NORMAL_VOLTAGES:
				return normal_voltages != NORMAL_VOLTAGES_EDEFAULT;
			case SimpleGridPackage.TRIPLEX_METER__HOUSE:
