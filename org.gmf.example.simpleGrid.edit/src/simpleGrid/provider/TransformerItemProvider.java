...
/**
 * This is the item provider adapter for a {@link simpleGrid.Transformer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimpleGridPackage.Literals.TRANSFORMER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPhasesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transformer_phases_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transformer_phases_feature", "_UI_Transformer_type"),
				 SimpleGridPackage.Literals.TRANSFORMER__PHASES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTransformer_configurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transformer_transformer_configuration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transformer_transformer_configuration_feature", "_UI_Transformer_type"),
				 SimpleGridPackage.Literals.TRANSFORMER__TRANSFORMER_CONFIGURATION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addGroupidPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transformer_groupid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transformer_groupid_feature", "_UI_Transformer_type"),
				 SimpleGridPackage.Literals.TRANSFORMER__GROUPID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTriplex_nodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transformer_triplex_node_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transformer_triplex_node_feature", "_UI_Transformer_type"),
				 SimpleGridPackage.Literals.TRANSFORMER__TRIPLEX_NODE,
				 true,
				 false,
				 true,
				 null,
